<?php
require_once("controller/OrderstatusCustomerController.php");
?>
<!doctype html>
<html>
...
<head>
    ...
    <link rel="stylesheet" href="View/CSS/orderStatus.css">
    ...
    <div class="container px-1 px-md-4 py-5 mx-auto">
        <div class="card">
            ...
            <div class="row justify-content-between top">
                ...
                <div class="row d-flex icon-content"> <img class="icon" src="View/Images/readytoship.png">
                    <div class="d-flex flex-column">
                        <p class="font-weight-bold">Ready<br>to<br>Ship</p>
                    </div>
                </div>
                <div class="row d-flex icon-content"> <img class="icon" src="View/Images/invoice.png">
                    <div class="d-flex flex-column">
