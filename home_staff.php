                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <!-- add code to disable the accept reject buttons once the order is accepted
                                  -->
                                <a data-placement="top" class="btn btn-success btn-xs glyphicon glyphicon-ok" href="#" title="View">Approve</a>
                                <a data-placement="top" class="btn btn-danger btn-xs glyphicon glyphicon-trash" href="#" title="Danger">Decline</a>
                                <a data-placement="top" class="btn btn-info btn-xs glyphicon glyphicon-usd" href="#" title="Danger">View</a>
                            </div>
